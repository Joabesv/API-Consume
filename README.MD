# Consuming a API made with JWT
Essa API foi desenvolvida para praticar estudos com consumo e desenvolvimento de uma API, utilizando AXIOS

## Endpoints

### GET /games
Esse endpoint é responsável por retornar a listagem de todos os 
games cadastrados no banco de dados.
